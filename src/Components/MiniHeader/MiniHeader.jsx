          ...
          <div onClick={() => setIsVisible(!isVisible)} className="flex items-center relative group">
            ...
            { isVisible ?
              <nav id="top_dropdown" className="absolute transition-all rounded-lg overflow-hidden w-60 top-full p-2 right-0 border-2 border-gray-300 group-hover:border-primary transform bg-white-pure">
                <button onClick={() => logoutEntity('/user/logout', history, '/user/login')} className="flex items-center bg-white w-full rounded-md px-4 py-2 text-brand-black hover:text-white-pure hover:bg-primary transition-all">
