...
const AdminMiniHeader = () => {
  return (
    <Fragment>
      <div className="flex justify-between w-full items-center bg-white-pure border-0 pr-10 border-blue-500">
        <div className="search relative w-2/5">
